...
num_episodes = 2000  # Number of episodes the agent does
...
actor.compile(opt_actor)
actor_target.compile(opt_actor)
critic_1.compile(opt_critic)
critic_2.compile(opt_critic)
critic_target_1.compile(opt_critic)
critic_target_2.compile(opt_critic)
...
for ep in range(1, num_episodes + 1):
    ...
    print(
        ...
        " Avg Reward -- {} \t Reward -- {}".format(ep, s // 3600, s % 3600 // 60, s % 60, timestep,
                                                   total_timestep, avg_reward.round(decimals=3),
                                                   episodic_reward))
    if avg_reward > 200:
        break
