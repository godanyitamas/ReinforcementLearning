...
class Agent:
    ...
    def get_critic(self):
        ...
        c1 = layers.Dense(400, activation='relu', name='critic_fc2')(c1)
    ...
    def save_log(self, actor, critic, avg_reward_list, ep_reward_list):
        ...
        plt.xlabel("Epizód")
        plt.ylabel("Jutalom")
        plt.title("AC-LunarLanderContinuous-v2")
        plt.legend()
        # plt.show()
