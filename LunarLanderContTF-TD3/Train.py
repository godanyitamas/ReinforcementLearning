...
critic_1 = agent.get_critic()           # Critic 1
critic_2 = agent.get_critic()           # Critic 2
actor_target = agent.get_actor()        # Target Actor
critic_target_1 = agent.get_critic()    # Target Critic
critic_target_2 = agent.get_critic()    # Target Critic
...
if __name__ == "__main__":
    ...
    for ep in range(1, num_episodes + 1):
        ...
        while True:
            ...
            critic_gradient = tape.gradient(q2_loss, critic_2.trainable_variables)
